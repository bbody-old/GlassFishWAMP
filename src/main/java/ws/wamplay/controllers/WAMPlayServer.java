...
import ws.wamplay.controllers.examples.TestRPCController;
import ws.wamplay.controllers.examples.TestPubSubController;
...
public class WAMPlayServer {
    ...
    public void onOpen(Session sClient) {
        // On first connection bind the Wamp controllers
        if (controllersBound == false) {
